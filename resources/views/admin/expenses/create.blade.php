        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-light">
                    <h5 class="mb-0 fw-bold">Form Tambah Pengeluaran</h5>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.expenses.store') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="Bahan Baku" {{ old('category') === 'Bahan Baku' ? 'selected' : '' }}>Bahan Baku</option>
                                    <option value="Utilitas" {{ old('category') === 'Utilitas' ? 'selected' : '' }}>Utilitas (Listrik, Air, Internet)</option>
                                    <option value="Operasional" {{ old('category') === 'Operasional' ? 'selected' : '' }}>Operasional</option>
                                    <option value="Maintenance" {{ old('category') === 'Maintenance' ? 'selected' : '' }}>Maintenance & Perbaikan</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Tuliskan deskripsi pengeluaran...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
