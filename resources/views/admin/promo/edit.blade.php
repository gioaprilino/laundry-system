    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header text-center bg-purple text-white rounded-top-4 py-3">
            <h4 class="mb-0 fw-bold">
                <i class="bi bi-pencil-square me-2"></i> Edit Promosi
            </h4>
            <p class="mb-0 small text-light opacity-75">
                Ubah informasi promosi yang sudah ada
            </p>
        </div>
            ...
            <form action="{{ route('promotions.update', $promotion->id) }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" value="{{ old('title', $promotion->title) }}" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Deskripsi</label>
                        <input type="text" name="description" value="{{ old('description', $promotion->description) }}" class="form-control">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="start_date" value="{{ old('start_date', $promotion->start_date->format('Y-m-d')) }}" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Tanggal Berakhir</label>
                        <input type="date" name="end_date" value="{{ old('end_date', $promotion->end_date->format('Y-m-d')) }}" class="form-control" required>
                    </div>
                ...
                <div class="mt-4 text-end">
                    ...
                    <button type="submit" class="btn btn-purple-soft px-4">
                        <i class="bi bi-save me-1"></i> Update Promosi
                    </button>
                </div>
            </form>
        </div>
